...
func Init() error {
	...
	viper.SetDefault("keybindings.half_page_up", "u")
	viper.SetDefault("keybindings.half_page_down", "d")
	viper.SetDefault("keybindings.up", []string{"up", "k"})
	viper.SetDefault("keybindings.down", []string{"down", "j"})
	viper.SetDefault("keybindings.left", []string{"left", "h"})
	viper.SetDefault("keybindings.right", []string{"right", "l"})
